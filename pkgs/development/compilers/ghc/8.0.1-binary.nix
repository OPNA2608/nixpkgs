...
stdenv.mkDerivation rec {
  ...
  # https://downloads.haskell.org/~ghc/8.0.1/
  src = fetchurl (
    {
      powerpc64-linux = {
        url = "${downloadsUrl}/${version}/ghc-${version}-powerpc64-unknown-linux.tar.xz";
        sha256 = "sha256-5kxge9AaUOAXskthDhG3VebtHKeR7cCu0GHwJ4AfBRw=";
      };
    }
